...
def upgrade():
    op.create_table(
        ...
        sa.Column('organism', sa.Unicode(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('rank', sa.Unicode(255), nullable=False),
    ...
    op.create_index(op.f('ix_taxon_rank'), 'taxon',
                    ['rank'], unique=False)
    op.create_table(
        'taxon_alias',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('taxon_id', sa.Integer(), nullable=False),
        sa.Column('language', sa.Unicode(255), nullable=True),
...
def downgrade():
    op.drop_index(op.f('ix_taxon_revision_taxon_id'),
                  table_name='taxon_revision')
